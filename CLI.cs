...
public class CLI
{
    ...
    public class Commands
    {
        public static void exportCli(string fileName)
        {
            ...
            SaveJsonFile(fileName, JsonSerializer.Serialize(fileContent));
        ...
        public static void exportApi(string fileName)
        {
            ...
            SaveJsonFile(fileName, JsonSerializer.Serialize(methods));
            info($"Keyword specification written to {fileName} in the current directory");
            Environment.Exit(1);
        }

        private static void SaveJsonFile(string fileName, string content)
        {
