  ...
  "keywords": {
    "ActivateTab": {
      ...
      "result": {
        ...
        "Exception": ("4173019151", exception("Der Reiter konnte nicht ausgewählt werden."))
      },
    ...
    "OpenSAP": {
      ...
      "result": {
        ...
        "Exception": ("867023488", exception("Die SAP GUI konnte nicht gestartet werden."))
      },
    ...
    "CloseConnection": {
      ...
      "result": {
        ...
        "Exception": ("3126586031", exception("Die Verbindung zum Server konnte nicht getrennt werden."))
      },
    ...
    "ExportTree": {
      ...
      "result": {
        ...
        "Exception": ("1031496719", exception("Die Baumstruktur konnte nicht exportiert werden."))
      },
    ...
    "AttachToRunningSAP": {
      ...
      "result": {
        ...
        "Exception": ("2425805237", exception("Die laufende SAP GUI konnte nicht übernommen werden."))
      },
    ...
    "ConnectToServer": {
      ...
      "result": {
        ...
        "SapError": ("3246364722", sap_error),
        "NoServerScripting": ("3495213352", no_server_scripting),
        "Exception": ("2125917532", exception("Die Verbindung konnte nicht hergestellt werden."))
      },
    ...
    "DoubleClickCell": {
      ...
      "result": {
        ...
        "Exception": ("3085546419", exception("Die Zelle konnte nicht doppelgeklickt werden."))
      },
    ...
    "DoubleClickTextField": {
      ...
      "result": {
        ...
        "Exception": ("3864288715", exception("Das Textfeld konnte nicht doppelgeklickt werden."))
      },
    ...
    "ExecuteTransaction": {
      ...
      "result": {
        ...
        "Exception": ("44997268", exception("Die Transaktion konnte nicht ausgeführt werden."))
      },
    ...
    "ExportForm": {
      ...
      "result": {
        ...
        "Exception": ("1173244444", exception("Die Maske konnte nicht exportiert werden."))
      },
    ...
    "FillTableCell": {
      ...
      "result": {
        ...
        "Exception": ("967617529", exception("Die Zelle konnte nicht ausgefüllt werden."))
      },
    ...
    "FillTextField": {
      ...
      "result": {
        ...
        "Exception": ("2213181692", exception("Das Textfeld konnte nicht ausgefüllt werden. Möglicherweise, weil der Inhalt nicht dazu passt."))
      },
    ...
    "PushButton": {
      ...
      "result": {
        ...
        "Exception": ("2781690642", exception("Der Knopf konnte nicht gedrückt werden."))
      },
    ...
    "PushButtonCell": {
      ...
      "result": {
        ...
        "Exception": ("2631037409", exception("Die Zelle konnte nicht gedrückt werden."))
      },
    ...
    "ReadTextField": {
      ...
      "result": {
        ...
        "Exception": ("3275278096", exception("Das Textfeld konnte nicht ausgelesen werden."))
      },
    ...
    "ReadText": {
      ...
      "result": {
        ...
        "Exception": ("3736254995", exception("Der Text konnte nicht ausgelesen werden."))
      },
    ...
    "ReadTableCell": {
      ...
      "result": {
        ...
        "Exception": ("798014810", exception("Die Zelle konnte nicht ausgelesen werden."))
      },
    ...
    "SaveScreenshot": {
      ...
      "result": {
        ...
        "Exception": ("55396597", exception("Eine Aufnahme des Fensters konnte nicht gespeichert werden"))
      },
    ...
    "SelectCell": {
      ...
      "result": {
        ...
        "Exception": ("308582997", exception("Die Zelle konnte nicht markiert werden."))
      },
    ...
    "SelectComboBoxEntry": {
      ...
      "result": {
        ...
        "Exception": ("127753839", exception("Der Eintrag konnte nicht ausgewählt werden."))
      },
    ...
    "SelectRadioButton": {
      ...
      "result": {
        ...
        "Exception": ("2613402433", exception("Das Optionsfeld konnte nicht ausgewählt werden."))
      },
    ...
    "SelectTextField": {
      ...
      "result": {
        ...
        "Exception": ("1892243256", exception("Das Textfeld konnte nicht markiert werden."))
      },
    ...
    "SelectTextLine": {
      ...
      "result": {
        ...
        "Exception": ("3958644268", exception("Die Textzeile konnte nicht markiert werden."))
      },
    ...
    "TickCheckBox": {
      ...
      "result": {
        ...
        "Exception": ("474228479", exception("Das Formularfeld konnte nicht angekreuzt werden."))
      },
    ...
    "UntickCheckBox": {
      ...
      "result": {
        ...
        "Exception": ("23065566", exception("Das Formularfeld konnte nicht abgewählt werden."))
      },
    ...
    "TickCheckBoxCell": {
      ...
      "result": {
        ...
        "Exception": ("3666296858", exception("Die Zelle konnte nicht angekreuzt werden."))
      },
